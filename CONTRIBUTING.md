...
5. Build: `dotnet build Akka.Persistence.Surgewave.slnx`
6. Test: `dotnet test Akka.Persistence.Surgewave.slnx`
...
2. Ensure all tests pass: `dotnet test Akka.Persistence.Surgewave.slnx`
3. Ensure zero build warnings: `dotnet build Akka.Persistence.Surgewave.slnx -c Release`
...
- Open a [GitHub Issue](https://github.com/Kuestenlogik/Akka.Persistence.Surgewave/issues)
