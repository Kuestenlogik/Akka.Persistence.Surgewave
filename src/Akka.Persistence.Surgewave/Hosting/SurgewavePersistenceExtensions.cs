namespace Akka.Persistence.Surgewave.Hosting;
        ...
        return $$"""
            akka.persistence {
                journal {
                    ...
                    surgewave {
                        class = "Akka.Persistence.Surgewave.Journal.SurgewaveJournal, Akka.Persistence.Surgewave"
                ...
                snapshot-store {
                    ...
                    surgewave {
                        class = "Akka.Persistence.Surgewave.Snapshot.SurgewaveSnapshotStore, Akka.Persistence.Surgewave"
                        plugin-dispatcher = "akka.actor.default-dispatcher"
                        bootstrap-servers = "{{setup.BootstrapServers}}"
                        protocol = "{{setup.Protocol}}"
        ...
        return $$"""
            akka.persistence.query {
                surgewave-read-journal {
                    class = "Akka.Persistence.Surgewave.Query.SurgewaveReadJournalProvider, Akka.Persistence.Surgewave"
