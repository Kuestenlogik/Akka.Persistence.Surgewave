namespace Kuestenlogik.Akka.Persistence.Surgewave.Snapshot;

using Akka.Actor;
using Akka.Configuration;
using Akka.Persistence;
using Akka.Persistence.Snapshot;
using Kuestenlogik.Akka.Persistence.Surgewave.Journal;
using Kuestenlogik.Akka.Persistence.Surgewave.Serialization;
