namespace Kuestenlogik.Akka.Persistence.Surgewave.Hosting;
        ...
        return $$"""
            akka.persistence {
                journal {
                    ...
                    surgewave {
                        class = "Kuestenlogik.Akka.Persistence.Surgewave.Journal.SurgewaveJournal, Kuestenlogik.Akka.Persistence.Surgewave"
                ...
                snapshot-store {
                    ...
                    surgewave {
                        class = "Kuestenlogik.Akka.Persistence.Surgewave.Snapshot.SurgewaveSnapshotStore, Kuestenlogik.Akka.Persistence.Surgewave"
                        plugin-dispatcher = "akka.actor.default-dispatcher"
                        bootstrap-servers = "{{setup.BootstrapServers}}"
                        protocol = "{{setup.Protocol}}"
        ...
        return $$"""
            akka.persistence.query {
                surgewave-read-journal {
                    class = "Kuestenlogik.Akka.Persistence.Surgewave.Query.SurgewaveReadJournalProvider, Kuestenlogik.Akka.Persistence.Surgewave"
